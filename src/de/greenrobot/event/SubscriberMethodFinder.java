...
class SubscriberMethodFinder {
	protected static final String ON_EVENT_METHOD_NAME = "onEvent";
    ...
    protected static final int MODIFIERS_IGNORE = Modifier.ABSTRACT | Modifier.STATIC | BRIDGE | SYNTHETIC;
    protected static final Map<String, List<SubscriberMethod>> methodCache = new HashMap<String, List<SubscriberMethod>>();

    protected final Map<Class<?>, Class<?>> skipMethodVerificationForClasses;
